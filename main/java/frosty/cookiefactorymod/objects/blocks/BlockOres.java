...
import frosty.cookiefactorymod.objects.blocks.item.ItemBlockVariants;
import frosty.cookiefactorymod.utils.handlers.EnumHandler;
import frosty.cookiefactorymod.utils.interfaces.IHasModel;
import frosty.cookiefactorymod.utils.interfaces.IMetaName;
...
public class BlockOres extends Block implements IHasModel, IMetaName {
	...
	public BlockOres(String name, String dimension) {
		super(Material.ROCK);
			...
			setDefaultState(this.blockState.getBaseState().withProperty(VARIANT, EnumHandler.EnumType.BRONZE));
